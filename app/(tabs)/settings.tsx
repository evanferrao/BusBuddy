...
export default function SettingsScreen() {
  ...
  const handleLogout = () => {
    Alert.alert(
      'Sign Out',
      'Are you sure you want to sign out? You will need to select your role again.',
      [
  ...
  const handleSwitchRole = () => {
    Alert.alert(
      'Switch Role',
      `You are currently a ${userRole === 'driver' ? 'Driver' : 'Student'}. Switch to ${userRole === 'driver' ? 'Student' : 'Driver'} mode?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Switch',
      ...
      <View style={[styles.profileCard, { backgroundColor: BUS_COLORS.primary }]}>
        ...
        <View style={styles.profileInfo}>
          ...
          <Text style={styles.profileRole}>
            {userRole === 'driver' ? 'Bus Driver' : 'Student'}
          </Text>
        </View>
      </View>
          ...
          {userRole === 'driver' ? (
            <>
              <InfoItem
                ...
                description="Start tracking to share your real-time location with students on your route."
                textColor={textColor}
              ...
              <InfoItem
                ...
                description="Get notified when students want you to wait or skip their stop."
                textColor={textColor}
                secondaryTextColor={secondaryTextColor}
              />
              <InfoItem
                ...
                description="See which students are waiting, running late, or skipping today."
                textColor={textColor}
                secondaryTextColor={secondaryTextColor}
              />
            </>
            ...
            <>
              <InfoItem
                ...
                description="See real-time location, distance, and ETA for your school bus."
                textColor={textColor}
                secondaryTextColor={secondaryTextColor}
              />
              <InfoItem
