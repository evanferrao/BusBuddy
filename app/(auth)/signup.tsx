...
import { validateDisplayName, validateEmail, validatePassword, validatePasswordsMatch } from '@/utils/validation';
    ...
    >
      ...
      >
        ...
        <View style={styles.header}>
          <IconSymbol name="bus" size={64} color={BUS_COLORS.primary} />
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.roleContainer}>
              ...
              >
                <IconSymbol name="car.fill" size={28} color={BUS_COLORS.primary} />
              ...
              >
                <IconSymbol name="person.fill" size={28} color={BUS_COLORS.primary} />
