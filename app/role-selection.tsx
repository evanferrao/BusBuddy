    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          <IconSymbol name="bus" size={48} color={BUS_COLORS.primary} />
        ...
        <View style={styles.roleContainer}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <IconSymbol name="car.fill" size={32} color={BUS_COLORS.primary} />
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <IconSymbol name="person.fill" size={32} color={BUS_COLORS.primary} />
