 ...
 * Driver Settings Tab
 * 
 * Settings for drivers including:
 * - User profile info
 * - Role switching
 * - App info
 * - Logout
...
export default function DriverSettingsScreen() {
  ...
  const handleSwitchRole = () => {
    Alert.alert(
      'Switch Role',
      'You are currently a Driver. To switch roles, you need to sign out and register with a different role.',
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Sign Out',
    ...
    >
      ...
      <View style={[styles.profileCard, { backgroundColor: BUS_COLORS.primary }]}>
        ...
        <View style={styles.profileInfo}>
          <Text style={styles.profileName}>{userName || 'Driver'}</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.menuGroup, { backgroundColor: cardColor }]}>
          ...
          <View style={styles.menuItem}>
            ...
            <Text style={[styles.menuValue, { color: secondaryTextColor }]}>Driver Mode</Text>
          </View>
        </View>
      </View>
    </ScrollView>
