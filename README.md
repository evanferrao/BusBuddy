...
Bus Buddy is a cross-platform mobile app built with React Native and Expo that connects bus drivers with passengers. It solves a common problem in rural India and other areas where buses don't have GPS tracking hardware.

## Features

### For Drivers
- **Live Location Sharing**: Share your real-time location with passengers using your phone's GPS
- **Passenger Notifications**: Receive instant notifications when passengers want you to wait, skip, or are ready
- **Passenger Status Overview**: See which passengers are waiting, running late, or skipping for the day
- **Route Management**: View all stops and passengers on your route
...
│   ├── passenger-dashboard.tsx  # Passenger's main screen
├── constants/
...
3. Passengers on your route will see your real-time location
4. Receive notifications when passengers send messages
5. Tap "Stop" when you're done with the route

### For Passengers  
1. Open the app and select "Passenger" role
...
Made with love for passengers who never want to miss their bus again!
